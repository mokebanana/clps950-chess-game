...
class King(chessPiece):
    ...
    def get_moves(self, board, board_coord, first_click_coord):
        possible_moves = []
        if self.color is True:
            if board_coord[board[0] + 1][board[1] + 0] is None or board_coord[board[0] + 1][board[1] + 0] == (
            ...
            if board_coord[board[0] - 1][board[1] - 0] is None or board_coord[board[0] - 1][board[1] - 0] == (
                ...
                pass
            if board_coord[board[0] + 0][board[1] + 1] is None or board_coord[board[0] + 0][board[1] + 1] == (
                    "wR" or "wP" or "wB" or "wK" or "wN" or "wQ"):
                possible_moves.append(tuple(map(sum, zip(first_click_coord, (0, 1)))))
            else:
                pass
